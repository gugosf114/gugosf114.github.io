import { filmFrame } from "./order-packaging-timeline.mjs?v=table-products-1";
...
export function initPackagingFilm({ canPlay }) {
  ...
  async function start(resume = false) {
    ...
    if (!video.getAttribute("src")) video.src = "media/cookie-packaging.mp4?v=table-products-1";
    ui("loading");
    try {
      await video.play();

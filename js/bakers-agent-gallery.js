(function () {
  ...
  var LANDING = /^(custom-cakes-[a-z-]+|anniversary-cakes|baby-shower-cakes|bridal-shower-cakes|cake-pops-party-favors|client-appreciation-gifts|conference-desserts|corporate-gifting|corporate-logo-cookies-[a-z-]+|corporate|custom-birthday-cakes-san-francisco|custom-cookies-san-francisco|custom-cookies|custom-cupcake-towers|delivery-areas|first-birthday-cakes|gender-reveal-cakes|graduation-cakes|hand-piped-logo-cookies|hand-piped-royal-icing-cookies|holiday-dessert-catering|office-birthday-cakes|product-launch-cakes|quinceanera-cakes|retirement-party-cakes|sculpted-3d-cakes|sweet-sixteen-cakes|team-building-treats|wedding-cake-flavors)$/;
